...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <header class="bg-blue-600 text-white p-4 md:p-6 shadow">
        <h1 class="text-lg md:text-2xl font-bold flex items-center gap-2">
            <ion-icon name="folder-open"></ion-icon> Artikel Kelas 3A
        </h1>
    </header>
    ...
    <main class="flex-grow max-w-6xl mx-auto w-full p-4 md:p-6">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
            <a href="upload.php"
                class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium shadow">
                ...
                <?php foreach ($articles as $a): ?>
                    ...
                    <div class="relative bg-white rounded-xl shadow hover:shadow-lg transition p-4 flex flex-col">
                        ...
                        <div class="mt-auto flex justify-between text-base">
                            <a href="<?= htmlspecialchars($a['gdrive_link']) ?>"
                                target="_blank"
    ...
    <footer class="bg-white border-t">
        <div class="max-w-6xl mx-auto px-4 py-4 text-center text-xs md:text-sm text-gray-500">
